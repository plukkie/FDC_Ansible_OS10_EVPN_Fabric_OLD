...
def execute_commands (hosts, commands):
    ...
    for ip in hosts:
        ...
        try:
            ...
            print('\n- OK -- All commands executed on ' + ip + '.')
            print('----------------------------------------------------------------------------------\n')
...
result = yes_or_no ('Are you sure you want ZTD stage your hosts from the ansible iventory?')
if (result == False):
    print()
    quit()
...
print('All Done.\nPlease allow the routers to reboot and wait ~7 mins before configure them to avoid unreachability errors.\n')
